...
export default function ScriptView() {
    ...
    if(isLoading) {
        return (
            <Block id="script-loading" className="bg-neutral-300 w-1/2 h-screen">
                <div className="m-2">
        ...
        return (
            <Block className="bg-neutral-300 w-1/2" id="script-error">
    ...
    return (
        <Block id="sidebar" className="px-6 bg-neutral-300 overflow-auto rounded-none w-1/2 2xl:w-1/4">
            <h2 className="mt-4 text-3xl">Trouble Brewing</h2>
            <hr className="border-black"/>
            <div className={"italic " + lato.className} >
